...
**Introduction project to setup rails back-end with react/redux front-end.  
...
To clone: git clone git@github.com:yosefgeda/hello-rails-react.git
to change to directory: cd hello-rails-react
...
Feel free to check the [issue page](https://github.com/yosefgeda/hello-rails-react/issues)
